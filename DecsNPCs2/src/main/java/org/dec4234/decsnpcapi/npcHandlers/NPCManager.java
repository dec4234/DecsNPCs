...
public class NPCManager {
	...
	public void spawn(Player pl) {
		...
		for (NPC npc : npcs) {
			...
			c.sendPacket(new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.ADD_PLAYER, entity));
			...
			Bukkit.getScheduler().scheduleAsyncDelayedTask(DecsNpcsMain.getInstance(), () -> {
				c.sendPacket(new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.REMOVE_PLAYER, entity));
			}, 80); 
		}
	}
